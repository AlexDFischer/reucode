function WriteToVTKGeneric(matrix, filename, z_scale_ratio)
...
fwrite(fid, ['# vtk DataFile Version 2.0' nl 'Volume example' nl 'ASCII' nl ...
    'DATASET STRUCTURED_POINTS' nl 'DIMENSIONS ' ...
    num2str(N) ' ' num2str(M) ' ' num2str(O) nl 'ASPECT_RATIO 1 1 ' num2str(z_scale_ratio) nl ... % I modified the aspect ratio of this line, before it was just 1 1 1
    'ORIGIN 0 0 0' nl 'POINT_DATA ' ...
    num2str(N*M*O) nl 'SCALARS values float 1' nl 'LOOKUP_TABLE default' nl]);
